//Importações para a composição da parte Header da página de Contatar Empresa:
import * as React from 'react';
import {View, Text, Image, StyleSheet } from 'react-native';


//Exportação da função da página Header de Contatar Empresas:
...
//Estilização da página Header de Contatar Empresas:
