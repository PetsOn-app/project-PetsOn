//Importações para a composição da parte HEADER da página da Exclusão do perfil do usuário:
import * as React from 'react';
import {View, Text, Image, StyleSheet } from 'react-native';


//Exportação da função para HEADER da página da Exclusão do perfil do usuário:
