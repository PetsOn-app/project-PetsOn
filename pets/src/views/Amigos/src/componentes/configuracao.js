//Importações para a composição da página configuração da Tela de Amigos:
import React, {useState} from 'react';
import {View, Text, StyleSheet, TouchableOpacity, Image } from 'react-native';


//Exportação da função Configuração da Tela de Amigos:
...
//Estilização da página Configuração da Tela de Amigos:
