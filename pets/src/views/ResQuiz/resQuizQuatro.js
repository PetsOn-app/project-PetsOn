    ...
    try {
      ...
      //Realizando a requisição para a postagem do quiz:
        const postagem = { 
            ...
            "urlFoto": "https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/sonserina.png?alt=media&token=7287826a-fecd-4093-8cfb-e5eb0c673102" ,
        }
    ...
    <View style={{backgroundColor: 'white'}}>
      ...
      <ScrollView>
        <View style={styles.imgView}>
          <Image style={styles.img2} source={require('./src/img/sonserina.png')} />
        </View>
