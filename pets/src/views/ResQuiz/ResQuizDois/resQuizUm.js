    ...
    try {
      ...
      //Realizando a requisição para a postagem do quiz:
        const postagem = { 
            ...
            "urlFoto": "https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/um.jpeg?alt=media&token=c03aff75-ff6c-4356-9428-54f12e1dc5e6 " ,
        }
    ...
    <View style={{backgroundColor: 'white'}}>
      ...
      <ScrollView>
        <View style={styles.imgView}>
          <Image style={styles.img2} source={{uri: 'https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/um.jpeg?alt=media&token=c03aff75-ff6c-4356-9428-54f12e1dc5e6'}}
            resizeMode='contain'
          />
        </View>
