    ...
    try {
      ...
      //Realizando a requisição para a postagem do quiz:
        const postagem = { 
            ...
            "urlFoto": "https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/quatro.jpeg?alt=media&token=c6e73d6f-1f9f-4405-b530-14bae5daba2e" ,
        }
    ...
    <View style={{backgroundColor: 'white'}}>
      ...
      <ScrollView>
        <View style={styles.imgView}>
          <Image style={styles.img2} source={{uri: 'https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/quatro.jpeg?alt=media&token=c6e73d6f-1f9f-4405-b530-14bae5daba2e'}} 
            resizeMode='contain'
          />
        </View>

        <View style={styles.view}>
          <TouchableOpacity style={styles.button} onPress={registerSonserina} >
