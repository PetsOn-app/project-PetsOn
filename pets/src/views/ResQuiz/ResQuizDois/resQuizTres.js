...
//EXPORTANDO A FUNÇÃO DA TELA DO CORVINAL:
export default function TelaQuiz({navigation}) {
  
  //FUNÇÃO PARA ADICIONAR À IMAGEM CORVINAL NO BANCO:
  async function registerCorvinal(event) {
    ...
    try {
      ...
      //Realizando a requisição para a postagem do quiz:
        const postagem = { 
            ...
            "urlFoto": "https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/tres.jpeg?alt=media&token=cd230ed0-a585-4310-98a3-7c9a26a145f8" ,
        }
    ...
    <View style={{backgroundColor: 'white'}}>
      ...
      <ScrollView>
        <View style={styles.imgView}>
          <Image style={styles.img2} source={{uri: 'https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/tres.jpeg?alt=media&token=cd230ed0-a585-4310-98a3-7c9a26a145f8'}}
            resizeMode='contain'
          />
        </View>

        <View style={styles.view}>
          <TouchableOpacity style={styles.button} onPress={registerCorvinal}>
