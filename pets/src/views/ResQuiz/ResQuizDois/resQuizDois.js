...
//EXPORTANDO A FUNÇÃO DA TELA DO QUIZ GRIFINÓRIA:
export default function TelaQuizDois({navigation}) {

  //FUNÇÃO PARA ADICIONAR À IMAGEM GRIFINÓRIA NO BANCO:
  async function registerGrifinoria(event) {
    ...
    try {
        ...
        const postagem = { 
            "legendaPost": " Meu Resultado do Quiz: O que o Jacquin diria sobre seu pet? ",
            "urlFoto": "https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/dois.jpeg?alt=media&token=8211082d-5ec7-4a13-8ffe-d3b97249711d" ,
        }
    ...
    <View style={{backgroundColor: 'white'}}>
      ...
      <ScrollView>
        <View style={styles.imgView}>
          <Image style={styles.img2} source={{uri: 'https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/dois.jpeg?alt=media&token=8211082d-5ec7-4a13-8ffe-d3b97249711d'}}
            resizeMode='contain'
          />
        </View>

        <View style={styles.view}>
          <TouchableOpacity style={styles.button} onPress={registerGrifinoria} >
