  ...
  async function registerGrifinoria(event) {
    ...
    try {
        ...
        const postagem = { 
            ...
            "urlFoto": "https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/Grifinoria.png?alt=media&token=e0167656-53af-44a5-ae08-f8b8dd22b6b7" ,
        }
    ...
    <View style={{backgroundColor: 'white'}}>
      ...
      <ScrollView>
        <View style={styles.imgView}>
          <Image style={styles.img2} source={require('./src/img/Grifinoria.png')}/>
        </View>
