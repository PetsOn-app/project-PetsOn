    ...
    try {
      ...
      //Realizando a requisição para a postagem do quiz:
        const postagem = { 
            ...
            "urlFoto": "https://firebasestorage.googleapis.com/v0/b/petson-eac94.appspot.com/o/corvinal.png?alt=media&token=57ce92c0-9914-47d2-bc2a-8dd41c62f73c" ,
        }
    ...
    <View style={{backgroundColor: 'white'}}>
      ...
      <ScrollView>
        <View style={styles.imgView}>
          <Image style={styles.img2} source={require('./src/img/corvinal.png')}/>
        </View>
